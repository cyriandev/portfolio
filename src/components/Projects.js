            ...
            <div>
                ...
                <div className="project">
                    <a href="https://notifyza.co.za">
                        <h1 className="d-flex align-items-center project-name"> <span style={{ marginRight: 10 }}>Notifyza</span> <ion-icon name="link-outline"></ion-icon></h1>
                    </a>
                ...
                <div className="project">
                    <a href="https://play.google.com/store/apps/details?id=com.cyriandev.loadshedding">
                        <h1 className="d-flex align-items-center project-name"><span style={{ marginRight: 10 }}>Loadshedding App</span> <ion-icon name="link-outline"></ion-icon></h1>
                    </a>
                ...
                <div className="project">
                    <a href="https://stokoza.co.za">
                        <h1 className="d-flex align-items-center project-name"><span style={{ marginRight: 10 }}>Stokoza</span> <ion-icon name="link-outline"></ion-icon></h1>
                    </a>
                ...
                <div className="project">
                    <a href="https://moviesntv.cyriandev.co.za">
                        <h1 className="d-flex align-items-center project-name"><span style={{ marginRight: 10 }}>Movies and Tv Web App</span> <ion-icon name="link-outline"></ion-icon></h1>
                    </a>
